...
import java.net.URL;
public class TestTacharTareaTest {
  ...
  @Test
  public void testTacharTarea() {
	  try {
		  driver.get("http://35.227.5.151:8080/");
		  Thread.sleep(1000);
		  driver.findElement(By.cssSelector(".form-control")).click();
		  Thread.sleep(1000);
		    driver.findElement(By.cssSelector(".form-control")).sendKeys("TareaTachada");
		    Thread.sleep(1000);
		    ...
		    Thread.sleep(1000);
		    assertThat(driver.findElement(By.cssSelector(".name")).getText(), is("TareaTachada"));
		    Thread.sleep(1000);
